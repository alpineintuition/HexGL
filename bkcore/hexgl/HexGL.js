...
bkcore.hexgl.HexGL.prototype.tweakShipControls = function()
{
	...
	if(this.difficulty == 1)
	{
		...
		c.airDrift = 0.07;
		c.thrust = 0.035;
		c.airBrake = 0.03; /* initialy 0.04 */
		c.maxSpeed = 3; /* initialy 9.6 */
		...
		c.collisionSpeedDecrease = 0.6; /* initialy 0.8 */
		c.collisionSpeedDecreaseCoef = 0.4; /* initialy 0.5 */
		c.rollLerp = 0.1;
		c.driftLerp = 0.4;
		c.angularLerp = 0.4;
	}
